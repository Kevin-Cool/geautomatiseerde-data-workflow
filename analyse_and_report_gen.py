...
def combined(df_daily):
    ...
    intro = "PM10 and PM2.5 reference the size of particulates measured in micro meters. In European countries there is no level of particulates which is considered safe.\n [Source](https://en.wikipedia.org/wiki/Particulates)"
